...
app.use(express.static("public"));  // to add static files we have to add this line and specify where are the files ex. "public"
...
app.post("/submit", (req, res) => {
  ...
  const randonAdj = adj[Math.floor(Math.random()*adj.length)];
